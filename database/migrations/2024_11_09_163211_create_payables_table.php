...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('payables', function (Blueprint $table) {
            $table->id();
            $table->dateTime('date_issued'); // Tanggal penerbitan tagihan
            $table->dateTime('due_date'); // Tanggal jatuh tempo
            $table->string('invoice', 60)->index(); // Nomor invoice, diindeks
            ...
            // Relasi dengan tabel contacts (misalnya kontak pemasok atau kreditor)
