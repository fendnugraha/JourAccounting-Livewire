...
class Transaction extends Component
{
    ...
    {
        $transactions = ModelsTransaction::selectRaw('invoice, warehouse_id, MAX(date_issued) as date_issued, SUM(cost * ABS(quantity)) as total, max(transaction_type) as transaction_type, MAX(contact_id) as contact_id')
