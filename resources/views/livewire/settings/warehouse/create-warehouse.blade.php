<form wire:submit.prevent="createWarehouse">
    <div class="mb-2">
        ...
        <x-text-input wire:model="prefix" type="text" class="mt-1 block w-full" autofocus />
        <x-input-error class="mt-1 text-xs" :messages="$errors->get('prefix')" />
    </div>
    <div class="mb-2">
    ...
    <div class="flex items-center justify-end mt-4">
        <x-action-message class="me-3" on="warehouse-created">
            {{ __('Saved.') }}
        </x-action-message>
