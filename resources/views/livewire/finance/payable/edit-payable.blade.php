    ...
    <form wire:submit="save">
        <div class="mb-4">
            <div class="grid grid-cols-3 gap-4 items-center">
                ...
                <div class="col-span-2">
                    <input type="datetime-local" wire:model.live="date_issued"
            ...
            <div class="grid grid-cols-3 gap-4 items-center">
                ...
                <div class="col-span-2">
                    <select class="w-full border rounded-lg p-2 text-sm @error('cred_code') border-red-500 @enderror"
                        name="cred_code" wire:model.live="cred_code">
            ...
            <div class="grid grid-cols-3 gap-4 items-center">
                ...
                <div class="col-span-2">
                    <select class="w-full border rounded-lg p-2 text-sm @error('debt_code') border-red-500 @enderror"
                        name="debt_code" wire:model.live="debt_code">
        ...
        <div class="mb-4">
            <div class="grid grid-cols-3 gap-4 items-center">
                ...
                <div>
                    <input type="number" wire:model.live="amount" placeholder="Rp. "
        ...
        <div class="mb-4">
            ...
            <div>
                <textarea cols="30" rows="2" wire:model.live="description" placeholder="Keterangan (Optional)"
