<form wire:submit="updateJournal">
    ...
    @if ($cashAccount != $debt_code)
    <div class="mb-2 grid grid-cols-1 sm:grid-cols-3 items-center">
        <x-input-label for="debt_code" :value="__('Rekening')" />
    ...
    @endif
    @if ($cashAccount != $cred_code)
    <div class="mb-2 grid grid-cols-1 sm:grid-cols-3 items-center">
        <x-input-label for="cred_code" :value="__('Rekening')" />
        <div class="sm:col-span-2">
    ...
    <div class="flex items-center justify-end mt-4">
        <x-action-message class="me-3" on="journal-updated">
