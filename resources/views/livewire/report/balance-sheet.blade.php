                ...
                <div class="text-gray-900">
                    <div class="grid grid-cols-2 gap-2 mb-4">
                        <div class="p-4 bg-gray-600 text-white shadow-sm sm:rounded-lg">
                            ...
                            <h2 class="text-end font-bold text-3xl"><i class="fa-solid fa-bank"></i> {{
                                number_format(intval($assets->flatten()->sum('balance'))) }}</h2>
                        </div>
                        <div class="p-4 bg-gray-600 text-white shadow-sm sm:rounded-lg">
                            <h5 class="">Total Liabilities</h5>
                            <h2 class="text-end font-bold text-3xl"><i class="fa-solid fa-file-invoice-dollar"></i> {{
                            ...
                            <table class="table-auto w-full text-sm mb-2 bg-white">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b" {{ $account->balance !== 0 ? '' : 'hidden' }}>
                                        ...
                                        <td class="p-3 text-end">{{ number_format(intval($account->balance)) }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
