            ...
            <div class="overflow-hidden sm:rounded-lg">
                <div class="text-gray-900">
                    <div class="grid grid-cols-2 gap-2 mb-4">
                        <div class="p-4 bg-gray-600 text-white shadow-sm sm:rounded-lg">
                            <h5 class="">Kenaikan Penurunan Kas</h5>
                            <h2 class="text-end font-bold text-3xl">{{ number_format(intval($growth)) }}</h2>
                        </div>
                        <div class="p-4 bg-gray-600 text-white shadow-sm sm:rounded-lg">
                            <h5 class="">Growth Rate (%)</h5>
                            <h2 class="text-end font-bold text-3xl">{!! $percentageChange > 0 ? '<i
                        ...
                        <table class="table-auto w-full text-sm mb-2 bg-white" {{$accountGroup->sum('balance') !== 0 ?
                            ...
                            <tbody>
                                ...
                                <tr {{$account->balance !== 0 ? '' : 'hidden'}}>
                                    <td class="p-3 text-start">{{ $account->acc_name }}</td>
                                    <td class="text-end p-3">{{ number_format(intval($account->balance)) }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    <div class="">
                        <table class="table-auto w-full text-sm bg-white">
                            <thead>
                                <tr class="border-b">
                                    <th class="p-3 text-start">Saldo Awal Kas</th>
                                    <th class="text-end p-3">{{ number_format(intval($startBalance)) }}</th>
                                </tr>
                                <tr class="border-b">
                                    <th class="p-3 text-start">Saldo Akhir Kas</th>
                                    <th class="p-3 text-end">{{ number_format(intval($endBalance)) }}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
